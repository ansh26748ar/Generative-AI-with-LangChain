...
# 1. Base LLM (completion-style)
llm = OpenAI(model="gpt-3.5-turbo-instruct")
response = llm.invoke("What is your favorite food?")
print("Base LLM:", response) 
# Likely Output: "...and what is your favorite drink?" (Pattern completion)

# 2. Chat Model (conversation-style)
chat = ChatOpenAI(model="gpt-4o-mini")
response = chat.invoke("What is your favorite food?")
print("Chat Model:", response.content)
# Likely Output: "As an AI, I don't eat, but I can tell you about popular dishes!"